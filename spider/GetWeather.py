...
class GetWeather:
    def __init__(self):
        ...
        self.headers = {'Accept': "*/*",
                        ...
                        'Connection': '',
                        'Cookie': 'f_city=上海|101020100|; Hm_lvt_080dabacb001ad3dc8b9b9049b36d43b=1637305568,1637734650,1639644011,1639710627; Hm_lpvt_080dabacb001ad3dc8b9b9049b36d43b=1639723697'.encode("utf-8").decode("latin1"),
                        'Host': 'd1.weather.com.cn',
                        'Referer': 'http://www.weather.com.cn/',
                        'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36', }
        # self.host = "127.0.0.1"
        # self.port = "3306"
        # self.database = "weathers"
        # self.username = "root"
    ...
    # def __getMysqlConnection__(self):
    ...
    def __getWeatherInfo__(self):
        # conn = self.__getMysqlConnection__()
        # cursor = conn.cursor()
