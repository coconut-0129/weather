...
'''
# 获取当日上海天气数据
today_data = GetData.getToday(57083)
...
'''
# 获取最近七天的天气数据
week_data=GetData.getWeek(57083)
# 最近上海一周的天气和空气
...
# 分页图的标题
tab = Tab()
tab.add(table_main(), "今日上海")
tab.add(grid_week_predict(), "未来上海")
tab.add(grid_week(), "近一周上海")
tab.add(today_china_table(), "今日中国天气")
# tab.add(today_china(), "今日全国空气质量")
tab.render("../../templates/html/天气网.html")
